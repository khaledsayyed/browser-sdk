...
function startInternalMonitoring(configuration) {
    ...
    if ((0, transport_1.canUseEventBridge)()) {
        var bridge_1 = (0, transport_1.getEventBridge)();
        ...
        var batch_1 = (0, startMonitoringBatch_1.startMonitoringBatch)(configuration);
    ...
    function withContext(message) {
        return (0, utils_1.combine)({ date: new Date().getTime() }, externalContextProvider !== undefined ? externalContextProvider() : {}, message);
    }
    return {
...
function addMonitoringMessage(message, context) {
    ...
    addToMonitoring((0, tslib_1.__assign)((0, tslib_1.__assign)({ message: message }, context), { status: StatusType.info }));
}
exports.addMonitoringMessage = addMonitoringMessage;
function addMonitoringError(e) {
    addToMonitoring((0, tslib_1.__assign)((0, tslib_1.__assign)({}, formatError(e)), { status: StatusType.error }));
}
