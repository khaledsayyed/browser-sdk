...
var utils = (0, tslib_1.__importStar)(require("../../tools/utils"));
...
function startSessionStore(options, productKey, computeSessionState) {
    ...
    var cookieWatch = setInterval((0, internalMonitoring_1.monitor)(retrieveAndSynchronizeSession), cookie_1.COOKIE_ACCESS_DELAY);
    ...
    function addSessionInconsistenciesMessage(cookieSession, cause) {
        (0, internalMonitoring_1.addMonitoringMessage)('Session inconsistencies detected', {
            debug: {
...
function persistSession(session, options) {
    ...
    (0, cookie_1.setCookie)(exports.SESSION_COOKIE_NAME, cookieString, exports.SESSION_EXPIRATION_DELAY, options);
}
