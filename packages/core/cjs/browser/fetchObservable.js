...
function afterSend(observable, responsePromise, startContext) {
    var _this = this;
    var reportFetch = function (response) { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
        ...
        return (0, tslib_1.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    context.status = 0;
                    context.responseText = (0, error_1.toStackTraceString)((0, tracekit_1.computeStackTrace)(response));
                ...
                case 4:
                    e_1 = _a.sent();
                    text = "Unable to retrieve response: ".concat(e_1);
                    return [3 /*break*/, 5];
                case 5:
