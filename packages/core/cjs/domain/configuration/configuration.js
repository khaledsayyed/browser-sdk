...
function validateAndBuildConfiguration(initConfiguration, buildEnv) {
    ...
    return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, (0, transportConfiguration_1.computeTransportConfiguration)(initConfiguration, buildEnv)), { beforeSend: initConfiguration.beforeSend && (0, catchUserErrors_1.catchUserErrors)(initConfiguration.beforeSend, 'beforeSend threw an error:'), cookieOptions: buildCookieOptions(initConfiguration), sampleRate: (_a = initConfiguration.sampleRate) !== null && _a !== void 0 ? _a : 100, service: initConfiguration.service, silentMultipleInit: !!initConfiguration.silentMultipleInit, 
        /**
         * beacon payload max queue size implementation is 64kb
         * ensure that we leave room for logs, rum and potential other users
         */
        batchBytesLimit: 16 * utils_1.ONE_KILO_BYTE, eventRateLimiterThreshold: 3000, maxInternalMonitoringMessagesPerPage: 15, 
        /**
